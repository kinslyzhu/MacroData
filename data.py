...
china_pork_price_line = plot_line_from_wind("S5914495","外三元生猪市场价","pork_price","1990-07-01","2019-09-22")
pork_price_22_city_line = plot_line_from_wind("S0113892","22省市猪肉平均价","pork_price_22_city","1990-07-01","2019-09-22")
china_pork_import_line = plot_line_from_wind("S5011199","中国猪肉进口量","china_pork_import","1990-07-01","2019-09-22")

china_breading_sows_line = plot_line_from_wind("S0114187","中国能繁母猪存栏量","china_breeding_sows_number","1975-01-01",
                                               "2019-09-14")

china_pork_number_line = plot_line_from_wind("S0114186","中国生猪存栏量","china_pork_number","1975-01-01","2019-09-14")
...
china_pork_corn_line = plot_line_from_wind("S0113895","猪粮比","pork_corn_ratio","1975-01-01","2019-09-14")
china_pork_feed_line = plot_line_from_wind("S5021737","猪料比","pork_feed_ratio","1975-01-01","2019-09-14")
...
line_liquidity_watch = plot_mutiple_line_from_wind(["M1006337", "M1001795" ,"M1001858"],"流动性溢价",["DR007","R007","Shibor3M"],"2018-01-01","2019-09-29")
df_liquidity_medium = get_data_from_wind_mutiple_same_date(["M1001858","M1001855"], "2006-01-01","2019-09-29",["Shibor3M","Shibor1W"])
...
df_liquidity_expectation = get_data_from_wind_mutiple_same_date(["M0048486","M1006337"], "2014-01-01","2019-09-29",["FR0071YIRS","DR007"])
...
df_china_bond =get_data_from_wind_mutiple_same_date(["M1000166","M1000164","M1000162","M1000158"], "2010-01-01","2019-09-29",["10Y","7Y","5Y","1Y"])
...
line_china_treasury = plot_mutiple_line_from_wind(["M1000166","M1000164","M1000162","M1000158"],"国债收益率",["10Y","7Y","5Y","1Y"],"2010-01-01","2019-09-29")
...
df_china_treasury_localgov_spread = get_data_from_wind_mutiple_same_date(windidStr,"2011-01-01","2019-09-29",treasury_localgov)
...
df_china_credit_bond = get_data_from_wind_mutiple_same_date(wind_treasury_creditbond_id,"2010-01-01","2019-09-30",treasury_creditbond_str)
...
df_1Y_credit_treasury_spread = get_data_from_wind_mutiple_same_date(wind_1Y_treasury_creditbond_id,"2010-01-01","2019-09-30",treasury_creditbond_1Y_str)
...
page.render(dt.datetime.now().date().strftime("%Y-%m-%d") + ".html")
